...
import com.example.practical62.views.productsView.ProductState
import com.example.practical62.views.productsView.ProductsViewModel
...
class ProductsViewModelTest {
    ...
    fun test_loadProduct() = runBlocking {
        val loadingData = flowOf(ProductState.LOADING)
